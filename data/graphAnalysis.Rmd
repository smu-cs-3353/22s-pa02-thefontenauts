...
ggplot(insertionInts, aes(x = size, y = insertion_time, color = format)) +
  geom_line() +
  labs(title = "Insertion Sort Time With Integer Data By Data Set Size and Data Format", x = "n", y = "Insertion Sort Time (s)") +
...
ggplot(insertionStrings, aes(x = size, y = insertion_time, color = format)) +
  geom_line() +
  labs(title = "Insertion Sort Time With String Data By Data Set Size and Data Format", x = "n", y = "Insertion Sort Time (s)") +
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(quickInts, aes(x = size, y = quick_time, color = format)) + 
  geom_line() + 
  labs(title = "Quick Sort Time With Integer Data By Data Set Size and Data Format", x = "n", y = "Quick Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(quickStrings, aes(x = size, y = quick_time, color = format)) + 
  geom_line() + 
  labs(title = "Quick Sort Time With String Data By Data Set Size and Data Format", x = "n", y = "Quick Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(mergeInts, aes(x = size, y = merge_time, color = format)) + 
  geom_line() + 
  labs(title = "Merge Sort Time With Integer Data By Data Set Size and Data Format", x = "n", y = "Merge Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(mergeStrings, aes(x = size, y = merge_time, color = format)) + 
  geom_line() + 
  labs(title = "Merge Sort Time With String Data By Data Set Size and Data Format", x = "n", y = "Merge Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(shellInts, aes(x = size, y = shell_time, color = format)) + 
  geom_line() + 
  labs(title = "Shell Sort Time With Integer Data By Data Set Size and Data Format", x = "n", y = "Shell Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(shellStrings, aes(x = size, y = shell_time, color = format)) + 
  geom_line() + 
  labs(title = "Shell Sort Time With String Data By Data Set Size and Data Format", x = "n", y = "Shell Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(introInts, aes(x = size, y = intro_time, color = format)) + 
  geom_line() + 
  labs(title = "Intro Sort Time With Integer Data By Data Set Size and Data Format", x = "n", y = "Intro Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(introStrings, aes(x = size, y = intro_time, color = format)) + 
  geom_line() + 
  labs(title = "Intro Sort Time With String Data By Data Set Size and Data Format", x = "n", y = "Intro Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
...
ggplot(timInts, aes(x = size, y = tim_time, color = format)) + 
  geom_line() + 
  labs(title = "Tim Sort Time With Integer Data By Data Set Size and Data Format", x = "n", y = "Tim Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
ggsave("timInts.svg")
```
...
ggplot(timStrings, aes(x = size, y = tim_time, color = format)) + 
  geom_line() + 
  labs(title = "Tim Sort Time With String Data By Data Set Size and Data Format", x = "n", y = "Tim Sort Time (s)") + 
  guides(color = guide_legend(title = "Data Format"))
